...
# D:\products\time_series\Full_data_download_one_id.py
...
# Path of CSV file
local_filename = "D:/products/time_series/TSFM-V1/TSFM/DPF/Data/FULL_DATA/test.json"
Temp_tar_file = 'D:/products/time_series/TSFM-V1/TSFM/DPF/Data/FULL_DATA/test.tar.gz'
veichle_ID = "1210120405965078528"


URL = "https://apis.intangles.com/vehicle/" + veichle_ID +"/obd_data/"+ str(1703247143000) + "/" + str(1703247444000) +"?fetch_result_from_multiple_sources=true"
print(URL)
DownloadFile(URL,local_filename)
out_path = 'D:/products/time_series/TEST/test.csv' 
